...
class ProductTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $products = [
            ...
            ['name' => 'Spanish Navy', 'description' => 'Spanish armada skin pack', 'price' => 6.99, 'discount' => 0.0, 'category' => 'skin', 'stock' => 9999, 'available' => true, 'image' => 'media/img/skins/blas-de-lezo/blas-de-lezo-template-image-small-caribbean-warfare-render-skin-buy.png', 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'Bismarck Skin', 'description' => 'The mighty feared German dreadnought', 'price' => 6.99, 'discount' => 0.0, 'category' => 'skin', 'stock' => 9999, 'available' => true, 'image' => 'media/img/skins/blas-de-lezo/blas-de-lezo-template-image-small-caribbean-warfare-render-skin-buy.png', 'created_at' => now(), 'updated_at' => now()],
