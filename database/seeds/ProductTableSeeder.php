...
class ProductTableSeeder extends Seeder
{
    ...
    {
        $products = [
            ['name' => 'C-W Avatar', 'description' => 'This is the default avatar!', 'price' => 0, 'discount' => 0.0, 'category' => 'avatar', 'stock' => 9999, 'available' => true, 'image' => 'media/img/default.png', 'created_at' => now(), 'updated_at' => now()],
