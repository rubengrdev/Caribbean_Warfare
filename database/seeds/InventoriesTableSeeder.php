...
class InventoriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $inventories = [
            ...
            ['user_id' => 1, 'product_id' => 2, 'amount' => 1, 'equipped' => true, 'created_at' => now(), 'updated_at' => now()],
            ['user_id' => 2, 'product_id' => 1, 'amount' => 1, 'equipped' => true, 'created_at' => now(), 'updated_at' => now()],
            ['user_id' => 2, 'product_id' => 2, 'amount' => 1, 'equipped' => true, 'created_at' => now(), 'updated_at' => now()]
        ];
